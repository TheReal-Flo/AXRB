...
constexpr uint64_t XR_COMPOSITION_LAYER_IMAGE_LAYOUT_VERTICAL_FLIP_BIT_FB = 1;
...
struct XrCompositionLayerEquirect2KHR {
    ...
    int32_t eyeVisibility; XrSwapchainSubImage subImage; XrPosef pose;
    float radius, centralHorizontalAngle, upperVerticalAngle, lowerVerticalAngle;
};
