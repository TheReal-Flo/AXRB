...
def build(sdk, directory):
    ...
    diagnostic = (ROOT / "tests/android/arm64_atomic_probe.cpp").read_text()
...
def main():
    ...
    directory = ROOT / "out/android/translation-probe"
